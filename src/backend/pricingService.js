...
const EMAIL_CONFIG = {
    ...
    auth: {
        ...
        pass: process.env.EMAIL_HOST_PASSWORD || 'lclmpbulgregnrse' // Gmail App Password (no spaces)
    }
};
...
const getCurrency = async (req, res) => {
    try {
        ...
        // For development testing (commented out for production)
        ...
        console.log(`💰 Currency determined: ${currency}`);
        console.log(`💱 Currency rate: ${CURRENCY_RATES[currency] || 1}`);
        ...
        return res.json({
            ...
            debug: {
                ...
                countryCode,
                currency,
                rate: CURRENCY_RATES[currency] || 1
            }
        });
    } catch (error) {
