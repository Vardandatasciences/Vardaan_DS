...
import Whitepaper from './pages/Products/GRC/Whitepaper';
...
import Smartcashflow from './pages/Products/SmartCashflow/Smartcashflow';
import VoiceLume from './pages/Products/VoiceLume/VoiceLume';
...
const AnalyticsTracker = () => {
  ...
  const getPageTitle = (pathname) => {
    const titles = {
      ...
      '/riskavaire/whitepaper': 'RiskaVaire Whitepaper - Vardaan Data Sciences',
      ...
      '/smartcashflow': 'Smart Cashflow - Vardaan Data Sciences',
      '/voicelume': 'VoiceLume - Vardaan Data Sciences',
      ...
      <Router>
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/riskavaire/whitepaper" element={<Whitepaper />} />
            ...
            <Route path="/smartcashflow" element={<Smartcashflow />} />
            <Route path="/voicelume" element={<VoiceLume />} />
